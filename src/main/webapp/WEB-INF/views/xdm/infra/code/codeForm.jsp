				...
				<c:choose>
					<c:when test="${empty param.seq }">
						<div class="d-flex justify-content-between my-5 text-center">
							<div class="col-2">
								<button id="btnList" type="button" class="btn btn-secondary" onclick = "location.href = '/codeList'"><i class="bi bi-list"></i></button>
							</div>
							<div class="col-2">
  ...
  <jsp:include page="../include/footer.jsp"></jsp:include>
  	<script>
	 	...
	 	$("#btnDelNy").on("click", function(){
			$("form[name=form]").attr("action", "/codeDelNy").submit();
		});
