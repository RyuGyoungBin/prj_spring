...
<!--                     </div> -->
	                <div class="col-12 d-flex flex-wrap justify-content-around py-4 mb-4 align-items-center">
						<div class="form-group col-12 col-xl-5">
							...
							<input class="form-control" name="zipCode" id="registerZipCode" type="text" placeholder="우편번호" value="<c:out value="${list.zipCode }"></c:out>" readonly>
						</div>
						...
						<div class="form-group col-12 col-xl-5">
							<label>Address</label>
							<input class="form-control" name="address" id="registerAddress" type="text" placeholder="주소" value="<c:out value="${list.address }"></c:out>" readonly>
						</div>
						<div class="form-group col-12 col-xl-5">
...
<!--                     파일첨부 -->
                    <div class="col-5 mb-3">
						...
						<div class="addScroll">
							<ul id="<c:out value="${name }"/>Preview" class="list-group bg-dark-subtle" style="min-height: 200px;">
								<c:forEach items="${listUploaded}" var="listUploaded" varStatus="statusUploaded">
									<c:if test="${listUploaded.type eq type }">
