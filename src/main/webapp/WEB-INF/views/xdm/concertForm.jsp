            ...
            <div class="card-body">
			  ...
			  <form name="form" method="post">
				...
				<div class="d-flex justify-content-between my-5 text-center">
					<div class="col-2">
						<button id="btnList" type="button" class="btn btn-secondary" onclick = "location.href = '/concertList'"><i class="bi bi-list"></i></button>
  ...
  <script src="/resources/admin/assets/js/main.js"></script>
  	<script>
 	 	$("#btnDelete").on("click", function(){
			$("form[name=form]").attr("action", "/concertDelete").submit();
		});
 	 	
 	 	$("#btnUpdate").on("click", function(){
  			$("form[name=form]").attr("action", "/concertUpdate").submit();
  		});
 	 	
 	 	$("#btnInsert").on("click", function(){
  			$("form[name=form]").attr("action", "/concertInsert").submit();
  		});
 	 	$("#btnDelNy").on("click", function(){
  			$("form[name=form]").attr("action", "/concertDelNy").submit();
  		});
